...
export function BitcoinConnectPayment({ 
  ...
  const createBoostTLVRecords = async (recipientName?: string) => {
    ...
    if (boostMetadata) {
      ...
      const podcastMetadata = {
        ...
        action: 'boost',
        app_name: boostMetadata.appName || getSiteName(),
      ...
      const sphinxData = {
        ...
        episode: boostMetadata.title || 'Unknown Title', 
        action: 'boost',
        app: boostMetadata.appName || getSiteName(),
        message: boostMetadata.message || '',
        amount: amount,
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      console.log(`⚡ Processing payments to ${paymentsToMake.length} recipient(s):`, paymentsToMake);
