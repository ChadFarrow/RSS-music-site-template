...
This is a live demonstration of the template with all features enabled:
...
The site works perfectly without this - it parses RSS feeds directly. The Podcast Index API can provide additional metadata and may be more reliable for some feeds:

- Get free API keys at [https://api.podcastindex.org/](https://api.podcastindex.org/)
- **Note:** Registration requires a non-Gmail email address
- Add keys to your Vercel environment variables:
  ```bash
